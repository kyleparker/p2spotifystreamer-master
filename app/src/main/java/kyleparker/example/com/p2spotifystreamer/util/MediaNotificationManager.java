...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    public static final String ACTION_PAUSE = "kyleparker.example.com.p2spotifystreamer.pause";
    public static final String ACTION_PLAY = "kyleparker.example.com.p2spotifystreamer.play";
    public static final String ACTION_PREV = "kyleparker.example.com.p2spotifystreamer.prev";
    public static final String ACTION_NEXT = "kyleparker.example.com.p2spotifystreamer.next";
    ...
    public MediaNotificationManager(MediaPlayerService service, Context context, ArrayList<MyTrack> tracks,
                                    String artistName, int position) {
        mService = service;
        mContext = context;
        mTracks = tracks;
        mArtist = artistName;
    ...
    private void addPlayPauseAction(Notification.Builder builder) {
        ...
        if (mPlaybackState.getState() == PlaybackState.STATE_PLAYING) {
            label = mService.getString(R.string.content_pause);
            icon = R.drawable.ic_pause_white_24dp;
            intent = mPauseIntent;
        } else {
            label = mService.getString(R.string.content_play);
    ...
    private PendingIntent createContentIntent() {
        boolean isLargeLayout = mContext.getResources().getBoolean(R.bool.large_layout);

        Intent intent = new Intent(mService, isLargeLayout ? MainActivity.class : PlayerActivity.class);
    ...
    private Notification createNotification() {
        ...
        if ((mPlaybackState.getActions() & PlaybackState.ACTION_SKIP_TO_PREVIOUS) != 0) {
            notificationBuilder.addAction(R.drawable.ic_skip_previous_white_24dp,
                        mService.getString(R.string.content_previous), mPreviousIntent);
        ...
        if ((mPlaybackState.getActions() & PlaybackState.ACTION_SKIP_TO_NEXT) != 0) {
            notificationBuilder.addAction(R.drawable.ic_skip_next_white_24dp,
                mService.getString(R.string.content_next), mNextIntent);
        }
        ...
        if (description.getIconUri() != null) {
            ...
            if (art == null) {
                ...
                art = BitmapFactory.decodeResource(mService.getResources(), R.drawable.ic_placeholder_artist);
            }
        }
...
//        LogHelper.e(TAG, "updateNotificationPlaybackState. mPlaybackState=" + mPlaybackState);
