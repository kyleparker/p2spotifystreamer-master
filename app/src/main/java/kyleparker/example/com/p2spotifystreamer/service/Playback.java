...
public class Playback implements
    ...
    public Playback(MediaPlayerService service) {
    ...
    public void play(MyTrack track) {
        ...
        boolean mediaHasChanged = !TextUtils.equals(trackId, mCurrentTrackId);
        if (mediaHasChanged) {
            mCurrentPosition = 0;
        ...
        public void onReceive(Context context, Intent intent) {
            if (AudioManager.ACTION_AUDIO_BECOMING_NOISY.equals(intent.getAction())) {
                ...
                if (isPlaying()) {
                    ...
                    i.putExtra(MediaPlayerService.CMD_NAME, MediaPlayerService.CMD_PAUSE);
